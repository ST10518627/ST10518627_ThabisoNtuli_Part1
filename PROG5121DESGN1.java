...
//Method to check username validation
    ...
    //Show login message
    public static String returnLoginStatus(boolean loginSuccess, String Name, String Surname){
        if (loginSuccess){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(returnLoginStatus(loginSuccess, Name, Surname));
        ...
        // Menu loop - keeps running until user select Exit
        boolean exit = false;
